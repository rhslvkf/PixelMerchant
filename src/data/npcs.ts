...
export const NPCS: Record<string, NPC> = {
  marcus_gold: {
    ...
    portraitId: "merchant_male_1",
    description:
      "황금의 길에서 수십 년간 행상을 해온 노련한 상인입니다. 베르단 제국과 특별한 거래 파트너십을 맺고 있습니다.",
    baseLocation: "royal_market",
    availableLocations: ["royal_market", "golden_harbor"],
    reputation: 0,
    specialties: [ITEM_KEYS.SILK, ITEM_KEYS.GEMSTONES, ITEM_KEYS.WINE],
    dialogues: [
      {
        id: "marcus_greeting",
        ...
        choices: [
          {
            ...
            effects: [
              ...
              { type: "item", target: ITEM_KEYS.SILK, value: 3, operation: "add" },
